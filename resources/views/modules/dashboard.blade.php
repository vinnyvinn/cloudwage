    ...
    <div class="row margin-top-10">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2">
                <div class="display">
                    <div class="number">
                        <h3 class="font-red-haze">{{ \Payroll\Models\Employee::all()->count() }}</h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2">
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">{{ \Payroll\Models\Loans::where('balance', '>', 0)->count() }}</h3>
                        <small>UNCLEARED LOANS</small>
                    </div>
                    <div class="icon">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat2">
                <div class="display">
                    <div class="number">
                        <h3 class="font-purple-soft">{{ \Payroll\Models\Advance::whereForMonth(\Carbon\Carbon::now()->endOfMonth()->format('Y-m-d'))->count() }}</h3>
                        <small>ADVANCES FOR MONTH</small>
                    </div>
                    <div class="icon">
