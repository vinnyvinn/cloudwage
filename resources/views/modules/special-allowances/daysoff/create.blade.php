...
@section('content')
    <div class="page-head">
        <div class="page-title">
            <h1>Days off Input - <small> Set</small></h1>
        </div>
    </div>
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('days-off.index') }}">Days off</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">Create</a>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="{{ route('days-off.store') }}" method="post" role="form">
                {{ csrf_field() }}
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="fa fa-briefcase font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase"> Days Off Details</span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label">
                            ...
                            <a class="btn btn-danger" href="{{ route('days-off.index') }}">Back</a>
                        </div>
                    </div>
                </div>
        </div>
