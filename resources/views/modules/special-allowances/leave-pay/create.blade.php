...
@section('content')
    <div class="page-head">
        <div class="page-title">
            <h1>Leave pay Input - <small> Set</small></h1>
        </div>
    </div>
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('leave-pay.index') }}">Leave pay</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">Create</a>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="{{ route('leave-pay.store') }}" method="post" role="form">
                {{ csrf_field() }}
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            <i class="fa fa-briefcase font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase"> Leave Pay Details</span>
                        </div>
                    </div>
